...
1. This included an introduction to Linear Algebra, specifically to do with two and three dimensional vectors and transformations.
    ...
    * It is used to deduce which colour the camera detects by assuming each color to be a point in 3D space. This means that we can have multiple points within that space as our target points, and just calculate which target point is closest to the read colour value.
...
4. Principles of Software Development and Programming.
    ...
    * They learnt a tool, Fork, that they use to push, pull and commit code to our online repository.
...
* [Fork](https://git-fork.com/). A user friendly git client with free (permanent as of writing) evaluation.
